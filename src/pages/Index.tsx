    ...
    <div className="min-h-screen w-full bg-white">
      <main className="relative">
        ...
        <section className="relative h-[80vh] bg-gradient-to-r from-blue-50 to-blue-100 overflow-hidden">
          ...
          {/* Main hero content */}
          <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center md:items-center text-center relative z-10 ml-0 md:ml-0">
            <div className="w-full flex flex-col items-center md:items-center pl-0 md:pl-0">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 drop-shadow-lg ml-32 sm:ml-0">KM3 Logi</h1>
              <div className="flex justify-center ml-32 sm:ml-0">
                <Link to="/contact">
